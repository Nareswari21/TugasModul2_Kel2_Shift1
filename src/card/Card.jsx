  ...
  return (
    <Row>
        ...
        <Column>
            <Card className={classes.root}>
                <Name>
                <Biodata nama="Erika Clara" nim="21120117130063" src="https://www.kindpng.com/picc/m/430-4302929_transparent-professional-woman-clipart-business-woman-cartoon-png.png" />
                </Name>
                <Select>
                    <option value="1">Kelas</option>
                    <option value="2">A</option>
